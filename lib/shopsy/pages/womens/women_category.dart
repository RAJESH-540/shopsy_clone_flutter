...
import 'package:shopsy_clone/shopsy/pages/womens/women_cateogory_detailsPage.dart';
            ...
            SingleChildScrollView(
              ...
              child: Row(
                children: [
                  CategoryListCard(
                     onTap: (){
                        Navigator.push(context,MaterialPageRoute(builder: (context)=> WomenCategoryDetailsPage(
